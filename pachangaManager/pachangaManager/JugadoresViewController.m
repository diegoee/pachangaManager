...
- (void) configureCell:(JugadorCell *)cell atIndexPath:(NSIndexPath *)indexPath { // Cogemos al jugador situado en un determinado indexPath
    Jugador *jugador = [self.fetchedResultsController objectAtIndexPath:indexPath];
    // Establecemos el texto del label de la celda con el nombre del jugador
    [cell.nombre setText:jugador.nombre];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath {
    JugadorCell *cell = [tableView dequeueReusableCellWithIdentifier:@"jugadorCell"
